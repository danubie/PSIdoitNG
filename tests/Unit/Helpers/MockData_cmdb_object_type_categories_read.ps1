...
Mock Invoke-RestMethod -ModuleName PSIdoitNG -MockWith {
    ...
    $thisIdoitObject = $MockData_Cmbd_type_categories_read | Where-Object { $_.Request.params.type -eq $requestBody.params.type }
...
#     }
# } -ParameterFilter {
#     (($body | ConvertFrom-Json).method) -eq 'cmdb.object_type_categories.update'
# }