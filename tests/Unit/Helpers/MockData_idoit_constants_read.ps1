# Simple mock: Return mocked data
Mock -CommandName Invoke-RestMethod -ModuleName 'PSIdoitNG' -MockWith {
    $body = $body | ConvertFrom-Json
    $MockData_idoit_constants_read.Response.id = $body.id
    $MockData_idoit_constants_read.Response
} -ParameterFilter {
    $body = $body | ConvertFrom-Json
    $body.method -eq 'idoit.constants'
}

$MockData_idoit_constants_read = [PSCustomObject] @{
    Endpoint = 'idoit.constants';
    Request  = [PSCustomObject] @{
        version = '2.0';
        id      = '5c89aafa-b09c-4fcb-ac6c-b7412189ef97';
        ...
        result  = [PSCustomObject] @{
            ...
            categories    = [PSCustomObject] @{
                g        = [PSCustomObject] @{
                    ...
                    C__CATG__NETWORK_INTERFACE             = 'Network-Interface';
                    ...
                    C__CATG__NET_CONNECTIONS_FOLDER        = 'Network listener';
                    C__CATG__NET_LISTENER                  = 'Listener';
                    C__CATG__NET_CONNECTOR                 = 'Network connections';
                    ...
                    C__CATG__NET_ZONE_OPTIONS              = 'Net zone options';
                    C__CATG__NET_ZONE_SCOPES               = 'Net zone scopes';
                    C__CATG__STACK_PORT_OVERVIEW           = 'Port Overview (Stacking)';
                    C__CATG__CABLE_CONNECTION              = 'Cable connection';
                    C__CATG__MULTIEDIT                     = 'Listedit';
                    C__CATG__DATABASE_FOLDER               = 'Database hierarchy';
                    C__CATG__DATABASE                      = 'DBMS information';
                    C__CATG__DATABASE_TABLE                = 'Database tables';
                    ...
                    C__CATG__FLOORPLAN                     = 'Floorplan'
                };
                s        = [PSCustomObject] @{
                    C__CATS__ENCLOSURE                         = 'Rack';
                    C__CATS__ROOM                              = 'Room';
                    C__CATS__SERVICE                           = 'System services';
                    ...
                    C__CATS__LICENCE_OVERVIEW                  = 'License assignment overview';
                    C__CATS__FILE_ACTUAL                       = 'Current file';
                    C__CATS__FILE_VERSIONS                     = 'File versions';
                    C__CATS__FILE_OBJECTS                      = 'Assigned Objects (Files)';
                    C__CATS__EMERGENCY_PLAN_ATTRIBUTE          = 'Emergency plan properties';
                    C__CATS__EMERGENCY_PLAN_LINKED_OBJECTS     = 'Emergency plan components';
                    C__CATS__WS_NET_TYPE                       = 'Net type';
                    C__CATS__WS_ASSIGNMENT                     = 'Wiring system objects';
                    ...
                    C__CATS__ORGANIZATION_PERSONS              = 'Assigned persons (Organization)';
                    ...
                    C__CATS__PERSON_GROUP_MEMBERS              = 'Person group members';
                    C__CATS__ORGANIZATION_CONTACT_ASSIGNMENT   = 'Assigned objects (Organization)';
                    C__CATS__PERSON_CONTACT_ASSIGNMENT         = 'Assigned objects (Person)';
                    C__CATS__PERSON_GROUP_CONTACT_ASSIGNMENT   = 'Assigned objects (Person group)';
                    ...
                    C__CATS__PDU_OVERVIEW                      = 'PDU Overview';
                    ...
                    C__CATS__CONTRACT_ALLOCATION               = 'Contract Objects';
                    ...
                    C__CATS__CHASSIS_CABLING                   = 'Chassis cabling';
                    ...
                    C__CATS__APPLICATION_SERVICE_ASSIGNED_OBJ  = 'Installation from Services';
                    C__CATS__APPLICATION_DBMS_ASSIGNED_OBJ     = 'Installation from DBMS';
                ...
                g_custom = [PSCustomObject] @{
                    C__CATG__CUSTOM_FIELDS_ASSIGNED_COMPONENTS         = 'Zugewiesene Komponenten';
                    C__CATG__CUSTOM_FIELDS_VERWENDUNG_IN_APPLIKATIONEN = 'Komponente von';
                    C__CATG__CUSTOM_FIELDS_KOMPONENTE                  = 'Detailinfos Komponente';
                    C__CATG__CUSTOM_FIELDS_GOVERNANCE                  = 'Governance';
                    C__CATG__CUSTOM_FIELDS_BETREUUNG_                  = 'Einstufung Betreuung';
                    C__CATG__CUSTOM_FIELDS_VERLINKUNGEN_NEU            = 'Verlinkungen NEU';
                    C__CATG__CUSTOM_FIELDS_ZUGRIFF_URLS_NEU            = 'Zugriff URLs NEU'
                }
            };
            recordStates  = [PSCustomObject] @{
            ...
            relationTypes = [PSCustomObject] @{
                ...
                C__RELATION_TYPE__NET_CONNECTIONS              = 'Network listener';
                ...
                C__RELATION_TYPE__FILE                         = 'File assignment';
                ...
                C__RELATION_TYPE_CUSTOM__KOMPONENTEN_ZUWEISUNG = 'Komponenten Zuweisung'
            };
            staticObjects = [PSCustomObject] @{
                C__OBJ__NET_GLOBAL_IPV4       = 'Global v4';
                C__OBJ__NET_GLOBAL_IPV6       = 'Global v6';
                C__OBJ__PERSON_ADMIN          = 'admin Applikation';
